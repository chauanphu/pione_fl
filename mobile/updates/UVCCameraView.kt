...
internal class UVCCameraView(
    ...
    fun initCamera() {
        // If permissions are not yet granted, request them and wait for onPermissionResult
        // Do NOT mark as error here; the user may grant permissions in the system dialog
